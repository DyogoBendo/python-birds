...
class Ponto():
    def __init__(self, x, y, caracter): #Como se fosse o metodo construtor
        self.caracter = caracter    #Define quais sao as propriedades da classe
        self.x = round(x)
        self.y = round(y)
...
class Fase():
    ...
    def adicionar_obstaculo(self, *obstaculos):
        ...
        # serve para não retornar nada -> pass
    ...
    def calcular_pontos(self, tempo):
        ...
        for passaro in self._passaros:
            ...
            for obstaculo_porco in self._obstaculos + self._porcos:
                passaro.colidir(obstaculo_porco, self.intervalo_de_colisao)
